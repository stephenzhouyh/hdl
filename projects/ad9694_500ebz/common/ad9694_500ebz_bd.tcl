...
ad_ip_instance axi_adxcvr axi_ad9694_xcvr
ad_ip_parameter axi_ad9694_xcvr CONFIG.NUM_OF_LANES $NUM_OF_LANES
ad_ip_parameter axi_ad9694_xcvr CONFIG.QPLL_ENABLE 1
ad_ip_parameter axi_ad9694_xcvr CONFIG.TX_OR_RX_N 0

adi_axi_jesd204_rx_create ad9694_jesd $NUM_OF_LANES

ad_ip_instance ad_ip_jesd204_tpl_adc ad9694_tpl_core
ad_ip_parameter ad9694_tpl_core CONFIG.NUM_CHANNELS $NUM_OF_CHANNELS
ad_ip_parameter ad9694_tpl_core CONFIG.CHANNEL_WIDTH $ADC_RESOLUTION
ad_ip_parameter ad9694_tpl_core CONFIG.NUM_LANES $NUM_OF_LANES
ad_ip_parameter ad9694_tpl_core CONFIG.TWOS_COMPLEMENT 0

ad_ip_instance util_cpack util_ad9694_cpack
ad_ip_parameter util_ad9694_cpack CONFIG.CHANNEL_DATA_WIDTH $CHANNEL_DATA_WIDTH
ad_ip_parameter util_ad9694_cpack CONFIG.NUM_OF_CHANNELS $NUM_OF_CHANNELS
ad_ip_parameter util_ad9694_cpack CONFIG.SAMPLE_WIDTH $SAMPLE_WIDTH

ad_ip_instance axi_dmac ad9694_dma
ad_ip_parameter ad9694_dma CONFIG.DMA_TYPE_SRC 1
ad_ip_parameter ad9694_dma CONFIG.DMA_TYPE_DEST 0
ad_ip_parameter ad9694_dma CONFIG.DMA_DATA_WIDTH_SRC $DMA_DATA_WIDTH
ad_ip_parameter ad9694_dma CONFIG.DMA_DATA_WIDTH_DEST 64

# shared transceiver core

ad_ip_instance util_adxcvr util_ad9694_xcvr
ad_ip_parameter util_ad9694_xcvr CONFIG.RX_NUM_OF_LANES $NUM_OF_LANES
ad_ip_parameter util_ad9694_xcvr CONFIG.TX_NUM_OF_LANES 0
...
for {set i 0} {$i < $NUM_OF_CHANNELS} {incr i} {
  ad_ip_instance xlslice ad9694_enable_slice_$i
  ad_ip_parameter ad9694_enable_slice_$i CONFIG.DIN_WIDTH $NUM_OF_CHANNELS
  ad_ip_parameter ad9694_enable_slice_$i CONFIG.DIN_FROM $i
  ad_ip_parameter ad9694_enable_slice_$i CONFIG.DIN_TO $i

  ad_ip_instance xlslice ad9694_valid_slice_$i
  ad_ip_parameter ad9694_valid_slice_$i CONFIG.DIN_WIDTH $NUM_OF_CHANNELS
  ad_ip_parameter ad9694_valid_slice_$i CONFIG.DIN_FROM $i
  ad_ip_parameter ad9694_valid_slice_$i CONFIG.DIN_TO $i

  ad_ip_instance xlslice ad9694_data_slice_$i
  ad_ip_parameter ad9694_data_slice_$i CONFIG.DIN_WIDTH $ADC_DATA_WIDTH
  ad_ip_parameter ad9694_data_slice_$i CONFIG.DIN_FROM [expr ($i + 1) * $CHANNEL_DATA_WIDTH - 1]
  ad_ip_parameter ad9694_data_slice_$i CONFIG.DIN_TO [expr $i * $CHANNEL_DATA_WIDTH]
